  ...
  ko: {
    ...
    contact: {
      ...
      form: {
        ...
        emailHint: '답변을 받으실 이메일 주소를 정확히 입력해주세요',
        emailKoreanWarning: '한글이 입력되었어요. 한/영(한영) 키를 눌러 영문으로 전환해주세요',
        emailInvalid: '올바른 이메일 형식이 아닙니다 (예: name@example.com)',
        emailValid: '올바른 이메일 형식입니다',
        company: '회사명',
        companyPlaceholder: '예: 데이포커스랩',
        position: '직책',
        positionPlaceholder: '예: 대표 / 기획팀장',
        optional: '선택',
        subject: '제목',
        subjectPlaceholders: {
          enterprise: '예: AI 업무 자동화 도입 문의',
          aipt: '예: AI PT 수강 문의',
          workshop: '예: 팀 대상 AI 워크숍 진행 문의',
          consulting: '예: AI 전략 컨설팅 문의',
          other: '예: 문의 제목을 입력해주세요',
        },
        message: '메시지',
        messagePlaceholders: {
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        email: 'Email',
        emailPlaceholder: 'name@example.com',
        emailHint: 'We will reply to this email address',
        emailKoreanWarning: 'Korean characters detected. Please switch your keyboard to English input',
        emailInvalid: 'Please enter a valid email (e.g., name@example.com)',
        emailValid: 'Valid email format',
        company: 'Company',
        companyPlaceholder: 'e.g., DayFocusLab',
        position: 'Position',
        positionPlaceholder: 'e.g., CEO / Product Manager',
        optional: 'optional',
        subject: 'Subject',
        subjectPlaceholders: {
          enterprise: 'e.g., Inquiry about AI workflow automation',
          aipt: 'e.g., Inquiry about AI PT program',
          workshop: 'e.g., Request for team AI workshop',
          consulting: 'e.g., AI strategy consulting inquiry',
          other: 'e.g., Enter your inquiry subject',
        },
        message: 'Message',
        messagePlaceholders: {
