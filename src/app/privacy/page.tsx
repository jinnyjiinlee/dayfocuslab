    ...
    <>
      <section className="pt-[96px] pb-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-[#050A34]">개인정보처리방침</h1>
          ...
          <div className="prose prose-gray max-w-none space-y-10 text-sm leading-relaxed text-gray-700">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제1조 (수집하는 개인정보 항목)</h2>
              <p className="mb-3">회사는 서비스 제공을 위해 다음과 같은 개인정보를 수집합니다.</p>
              <div className="bg-[#F7F9FC] p-5 rounded-xl space-y-4">
                <div>
                  <h3 className="font-semibold text-[#050A34] mb-2">1. 무료 상담 신청 시 (구글폼)</h3>
                ...
                <div>
                  <h3 className="font-semibold text-[#050A34] mb-2">2. 결제 시</h3>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>필수: 이름, 이메일, 연락처, 결제 정보</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-semibold text-[#050A34] mb-2">3. 문의 시</h3>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>필수: 이름, 이메일</li>
                    <li>선택: 연락처, 문의 내용</li>
                  </ul>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제2조 (개인정보의 수집 및 이용 목적)</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제3조 (개인정보의 보유 및 이용 기간)</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제4조 (개인정보의 제3자 제공)</h2>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-blue-200">
                      ...
                      <th className="text-left py-2 font-semibold text-[#050A34] bg-blue-50 px-2 rounded-r">위탁 업무</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제6조 (개인정보의 파기)</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제7조 (이용자의 권리와 행사 방법)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제8조 (개인정보의 안전성 확보 조치)</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제9조 (개인정보 보호책임자)</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제10조 (개인정보처리방침 변경)</h2>
            ...
            <section className="border-t border-blue-100 pt-8">
              <h2 className="text-lg font-bold text-[#050A34] mb-3">사업자 정보</h2>
          ...
          <div className="mt-12">
            <Link href="/" className="text-sm text-gray-500 hover:text-[#050A34] transition-colors">
              &larr; 홈으로 돌아가기
            </Link>
          </div>
        </div>
