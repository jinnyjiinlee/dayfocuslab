      ...
      <section className="py-24 bg-[#F7F9FC]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex flex-col items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-[#0B1222] text-lg mb-1">
                    {isKo ? '전화 문의' : 'Phone'}
                  </p>
            ...
            >
              <div className="flex flex-col items-start gap-4">
                <div className="w-14 h-14 bg-[#0B1222] rounded-2xl flex items-center justify-center">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="flex flex-col items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-[#0B1222] text-lg mb-1">LinkedIn</p>
          ...
          <div className="mt-8 bg-white p-8 rounded-3xl border border-gray-100">
            <h3 className="font-bold text-[#0B1222] text-lg mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-500">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#0B1222]">{isKo ? '데이포커스랩' : 'Day Focus Lab'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gray-400 flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-[#0B1222]">{isKo ? '이지인' : 'Jiin Lee'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gray-400 flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-[#0B1222]">{isKo ? '서울특별시 광진구 능동로 330, 5층' : '5F, 330 Neungdong-ro, Gwangjin-gu, Seoul'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gray-400 flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-[#0B1222]">546-10-03346</p>
                </div>
              </div>
            </div>
          </div>
