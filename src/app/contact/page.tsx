      ...
      <section className="py-20 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ContactCard variant="kakao" href="https://open.kakao.com/o/sSp6Rcli" external title={ko ? '카카오톡 상담' : 'KakaoTalk'} subtitle={ko ? '가장 빠르게 상담받으실 수 있습니다' : 'Fastest way to reach us'} linkLabel={ko ? '바로가기' : 'Open Chat'} iconBg="bg-[#3C1E1E]"
              icon={<svg className="w-8 h-8" viewBox="0 0 24 24" fill="#FEE500"><path d="M12 3C6.48 3 2 6.58 2 10.9c0 2.78 1.86 5.22 4.65 6.6-.15.53-.54 1.91-.62 2.21-.1.37.14.36.29.26.12-.08 1.82-1.22 2.56-1.72.69.1 1.4.15 2.12.15 5.52 0 10-3.58 10-7.9S17.52 3 12 3z"/></svg>} />
