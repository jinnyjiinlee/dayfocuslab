    ...
    <>
      <section className="pt-[96px] pb-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-[#050A34]">이용약관</h1>
          ...
          <div className="prose prose-gray max-w-none space-y-10 text-sm leading-relaxed text-gray-700">
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제1조 (목적)</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제2조 (정의)</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제3조 (약관의 효력 및 변경)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제4조 (서비스의 내용)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제6조 (환불 및 취소 정책)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제7조 (이용자의 의무)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제8조 (회사의 의무)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제9조 (면책조항)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[#050A34] mb-3">제10조 (분쟁 해결)</h2>
              <ol className="list-decimal pl-5 space-y-2">
