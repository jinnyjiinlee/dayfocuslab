      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-gray max-w-none space-y-10 text-sm leading-relaxed text-gray-700">
            ...
            <section>
              <h2 className="text-lg font-bold text-black mb-3">제4조 (서비스의 내용)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-black mb-3">제5조 (서비스 요금)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-black mb-3">제6조 (환불 및 취소 정책)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-black mb-3">제7조 (이용자의 의무)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-black mb-3">제8조 (회사의 의무)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-black mb-3">제9조 (면책조항)</h2>
              <ol className="list-decimal pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-black mb-3">제10조 (분쟁 해결)</h2>
              <ol className="list-decimal pl-5 space-y-2">
